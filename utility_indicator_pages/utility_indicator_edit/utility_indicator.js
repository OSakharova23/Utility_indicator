...
export class utility_indicator_EditPage {
    constructor(utility_indicator_parent, utility_indicator_id) {
        ...
        this.utility_indicator_isNew = !utility_indicator_id;
    }
                                ...
                                <div class="card-body" style="padding: 30px;">
                                    ...
                                    <form id="utility_indicator_edit-form" style="${!this.utility_indicator_isNew ? 'display: none;' : ''}">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="utility_indicator_title" style="border: 1px solid #91bbe6; border-radius: 5px; padding: 10px;">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="utility_indicator_tariff" style="border: 1px solid #91bbe6; border-radius: 5px; padding: 10px;">
                                        </div>
                                        <div class="mb-3">
